...
def _(dj):
    ...
    return base_durations, track1b_base
...
@app.cell
def _(base_durations, dj, itertools, track1b_base):
...
@app.cell
def _(dj, random, shuffle_pitches, track1a_n):
...
@app.cell
def _(dj, track1a_n, track1b_n, track1c_n):
...
@app.cell
def _(track1a_n, track1b_n, track1c_n):
...
@app.cell
def _(track1b_n, track1c_n, track2b_n, track2c_n):
...
@app.cell
def _(dj, track1a_n, track1b_n, track1c_n, track2a_n, track2b_n, track2c_n):
...
@app.cell
def _(dj, track1, track2a_n, track2b_n, track2c_n):
...
@app.cell
def _(dj, solfege_alterdur, solfege_alterdur_cp, solfege_alterdur_d):
    ...
    solfege_alterdur_voice = dj.rhythm.isorhythm(
        pitches=[p[0] for p in _voice], durations=solfege_alterdur_d
    )
...
@app.cell
def _(dj, math, track1a_n, track1b_no, track1c_no):
    _measure_length = 4
    track3 = []

    for _track, _mode in zip(
        [track1a_n, track1b_no, track1c_no], ["major", "minor", "major"]
    ):
...
def _(mo):
    ...
    <div class="main-container">
        <div class="nav-container">
            <a href="https://marimo.io/p/@djalgo/notebook-6hmu8z" class="nav-link" target="_top">← previous</a>
            <div class="title">Djalgo's User Guide</div>
            <a href="https://marimo.io/p/@djalgo/notebook-xsbu6g" class="nav-link" target="_top">next →</a>
        </div>
        <div class="toc-container">
            <ul>
                ...
                <li><a href="https://marimo.io/p/@djalgo/notebook-1ehwep"class="active" target="_top">> 04. Minimalism</a></li>
                <li><a href="https://marimo.io/p/@djalgo/notebook-xsbu6g" target="_top">05. Walks</a></li>
